...
<?php
	...
	if($_POST) {
	    ...
	    if($conn->query($sql) === TRUE) {
	         ...
	         echo '<h2 style=";margin-top:30px;">Course succcessfully Deleted</h2>';
	        echo "<a href='../home.php'><button style='margin-left: 45%' type='button' class='custom-btn btn-1'>Back to courses</button></a>";
	    } else {
