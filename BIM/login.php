            ...
            <div class="parallax-three">
              <h2>BIM EDUCATION AND TRAINING</h2>
                  ...
                  <form class="form-inline" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
                    ...
                    <input type="password" name="pass" class="form-control" placeholder="Enter Your Password" maxlength="15" value="<?php echo $pass; ?>"/>

                    <span class="text-danger"><?php echo $passError; ?></span>

                    <button type="submit" name="btn-login" class="submit-btn btn-1">Login</button>
                    <a href="register.php" class="custom-btn">Create a new Account</a>
